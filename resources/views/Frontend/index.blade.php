...
<div class="site-wrap">
                            ...
                            <li class="has-children">
                                ...
                                <ul class="dropdown">
                                   @foreach($category as $value)
                                        <li class="has-children"><a href="#">{{$value->name}}</a>
                                            <ul class="dropdown">
                                                <li><a href="{{route('destination')}}">manish</a> </li>
                                                <li><a href="{{route('destination')}}">{{$value->blogs->first()->title}}</a> </li>
                                            </ul>
                                        </li>
                                       @endforeach
                                </ul>
    ...
    <div class="slide-one-item home-slider owl-carousel">
        ...
        <div class="site-blocks-cover overlay" style="background-image: url({{url('images/lakeside.jpg')}});"
        ...
        <div class="site-blocks-cover overlay" style="background-image: url({{url('images/mount.jpg')}});"
             data-aos="fade" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row align-items-center justify-content-center text-center">
        ...
        <div class="site-blocks-cover overlay" style="background-image: url({{url('images/ghandruk.jpg')}});"
             data-aos="fade" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <a href="#" class="unit-1 text-center">
                        <img src="{{url('images/ghandruk.jpg')}}" alt="Image" class="img-fluid">
                ...
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <a href="#" class="unit-1 text-center">
                        <img src="{{url('images/mount.jpg')}}" alt="Image" class="img-fluid">
                        <div class="unit-1-text">
                ...
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <a href="#" class="unit-1 text-center">
                        <img src="{{url('images/lakeside.jpg')}}" alt="Image" class="img-fluid">
                        <div class="unit-1-text">
